...
namespace smsverifylibrary
{
     ...
     public class NotifySmS
    {
         ...
         public class RecoverSmS
    {
            public void RecoverySmS(string CustomerPhoneNumber, string TempPW)
            {
                ...
                try
                {
                    ...
                    var message = MessageResource.Create(
                        body: "Your Temporary password is " + TempPW + " Please use this in the next 15 minutes to reset your password.",
                        from: new Twilio.Types.PhoneNumber(TwilioNumber),
                        to: new Twilio.Types.PhoneNumber(CustomerPhoneNumber)
                    );
                    //Use Account Sid for testing to make sure the message was sent
